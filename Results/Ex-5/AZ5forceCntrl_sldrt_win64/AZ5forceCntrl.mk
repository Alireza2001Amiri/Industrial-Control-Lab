...
MODEL                := AZ5forceCntrl
MODULES              := AZ5forceCntrl_data.c AZ5forceCntrl_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := AZ5forceCntrl.mk
...
#
MODELLIB                  := AZ5forceCntrllib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := AZ5forceCntrl_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;$(MATLAB_ROOT)/simulink/include/sf_runtime;C:/Users/Alireza7/Desktop/Ex-5/AZ5forceCntrl_sldrt_win64;C:/Users/Alireza7/Desktop/Ex-5;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
